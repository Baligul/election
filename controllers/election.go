...
func init() {
    ...
    orm.RegisterDataBase("ec2-54-225-93-34.compute-1.amazonaws.com:5432", "postgres", "user=ggxssikrsehequ password=sQElIpN-CHqcFFNAx7mJO31Y3v dbname=da6obv8tnlvcev sslmode=disable")
