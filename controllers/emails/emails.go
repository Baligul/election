...
/*
   ...
   curl -X POST -H "Content-Type: application/json" -d '{}' "http://107.178.208.219:80/api/email/voters/slips?mobile_no=9343352734&token=b4704cf9a3dc3faa"

   curl -X POST -H "Content-Type: application/json" -d '{}' "http://localhost:8080/api/emails?mobile_no=9343352734&token=b4704cf9a3dc3faa"
*/
