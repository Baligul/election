/*
   ...
   GET STATISTIC
   curl -X POST -H "Content-Type: application/json" -d '{"state_number":[], "district_number":[20], "voter_id":[],"ac_number":[],"part_number":[],"section_number":[],"serial_number_in_part":[],"name_english":[],"name_hindi":[],"relation_name_english":[],"relation_name_hindi":[],"gender":[],"id_card_number":[], "district_name_hindi":[],"district_name_english":[],"ac_name_english":[],"ac_name_hindi":[],"section_name_english":[],"section_name_hindi":[],"religion_english":[],"religion_hindi":[],"age":[],"vote":[],"email":[],"mobile_no":[],"image":[]}' http://104.197.6.26:8080/api/statistic
   ...
   GET OTP
   curl -X POST -H "Content-Type: application/json" -d '{"mobile_no": 9564783954}' http://104.197.6.26:8080/api/otp

   Register
   curl -X POST -H "Content-Type: application/json" -d '{"mobile_no": 9343352734, "otp":23435}' http://104.197.6.26:8080/api/register

   Get List
   curl -X POST -H "Content-Type: application/json" -d '{"districts": ["Moradabad"], "acs":["Kanth", "Bilari"]}' http://104.197.6.26:8080/api/list

   Set Voter
   curl -X POST -H "Content-Type: application/json" -d '{"district":"Moradabad", "voter_id": [12345,20045], "vote":1, "email":"example@example.com","mobile_no":9456732819,"image":"jsdjsd22ksndsndsnk22knknlcxx"}' http://104.197.6.26:8080/api/voter

   Read Json
   curl -X POST -H "Content-Type: application/json" -d @json/data.json http://104.197.6.26:8080/api/read/json
*/
